...
- **General tweets feed:** `GET http://127.0.0.1:5000/api/news/tweet`
- **Coin-specific tweets:** `GET http://127.0.0.1:5000/api/news/search-topic?query=<COIN>`

**Via server proxies:**
- `GET http://127.0.0.1:5000/api/news/tweet`
- `GET http://127.0.0.1:5000/api/news/search-topic?query=<COIN>`
